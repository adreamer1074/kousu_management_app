...
urlpatterns = [
    ...
    # チケット管理
    # path('tickets/', views.TicketListView.as_view(), name='ticket_list'), # 使用しない
    # path('tickets/create/', views.ProjectTicketCreateView.as_view(), name='ticket_create_global'), #使用しない
    ...
    path('<int:project_pk>/tickets/', views.TicketListView.as_view(), name='project_ticket_list'),
    path('<int:project_pk>/tickets/create/', views.ProjectTicketCreateView.as_view(), name='project_ticket_create'),
